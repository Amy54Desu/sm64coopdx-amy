...
void bhv_hidden_star_trigger_loop(void) {
    if ((o->oInteractStatus & INT_STATUS_INTERACTED) || ((gMarioStates[0].visibilityFlags & MARIO_VISIBLE_TO_FRIENDLIES) && obj_check_if_collided_with_object(o, gMarioObjects[0]) == 1)) {
